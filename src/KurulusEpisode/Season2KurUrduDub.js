...
<Fade right>
 ...
 <Fade left>
  ...
  <Fade right>
         <article>
          <h2> Episode 22
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-22">
         ...
         <article>
             <h2> Episode 23
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-23">
            ...
            <article>
             <h2> Episode 24
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-24">
  ...
  <Fade left>
         <article>
          <h2> Episode 25
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-25">
  ...
  <Fade left>
         <article>
          <h2> Episode 31
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-31">
           ...
           <article>
             <h2> Episode 32
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-32">
            ...
            <img className="article-img" src={KurulusPic2} alt="Episode 32" />
              ...
              <article>
             <h2> Episode 33
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-33">
  ...
  <Fade right>
         <article>
          <h2> Episode 34
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-34">
           ...
           {/* <article>
            ...
            <img className="article-img" src={KurulusPic2} alt="Episode 35" />
              ...
              <article>
             <h2> Episode 36
             <Link exact to="/kurulus-osman-season2-urdu-dubbing-36">
