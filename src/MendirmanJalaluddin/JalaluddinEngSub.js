...
<Helmet>
<title>Mendirman Jalolddin Series in English Subtitles</title> 
</Helmet>
      ...
      <Fade left>
        ...
        <article>
            <h2> Episode 1
            <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-1">
        ...
        <article>
            <h2> Episode 2
            <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-2">
        ...
        <article>
             <h2> Episode 3
             <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-3">
        ...
        <article>
             <h2> Episode 4
             <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-4">
        ...
        <article>
            <h2> Episode 5
      <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-5">
        ...
        <article>
             <h2> Episode 6
        <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-6">
        ...
        <article>
             <h2> Episode 7
        <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-7">
        ...
        <article>
             <h2> Episode 8
        <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-8">
        ...
        <article>
             <h2> Episode 9
             <Link exact to="/mendirman-jalal-ud-english-sub-din-episode-9">
      ...
      <Fade right>
        ...
        <article>
             <h2> Episode 10
             <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-10">
        ...
        <article>
             <h2> Episode 11
        <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-11">
        ...
        <article>
             <h2> Episode 12
        <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-12">
        ...
        <article>
             <h2> Episode 13
             <Link exact to="/mendirman-jalal-ud-din-english-sub-episode-13">
...
export default JalaluddinEngSub;
