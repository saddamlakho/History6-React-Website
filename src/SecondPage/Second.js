...
// import TextLight from '../Tubelight/TextLight'
...
function Second() {
  ...
  return (
    <div>
              ...
              <Helmet>
                <title>Dirilis Ertugrul in Urdu Dubbing</title> 
             </Helmet>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Fade left>
          <Link  exact  to="/dirilis-ertugrul-season1-urdu-dubbing"> 
      ...
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Fade left>
          <Link  exact  to="/dirilis-ertugrul-season2-urdu-dubbing"> 
      ...
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Fade left>
          <Link  exact  to="/dirilis-ertugrul-season3-urdu-dubbing"> 
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Fade left>
          <Link  exact  to="/dirilis-ertugrul-season4-urdu-dubbing"> 
      ...
      <div className="p-4 lg:w-1/3">
        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <Fade left>
          <Link  exact  to="/dirilis-ertugrul-season5-urdu-dubbing"> 
